...
dataPath = 'data/'
L = np.genfromtxt(dataPath + 'ligand.csv', delimiter = ',')
...
#     t  = t*60 #converting time to seconds
  ...
  #     % free Akt
    ...
    return dys
def calcSteadyState(k_all, L = np.genfromtxt(dataPath + 'ligand.csv', delimiter = ',')):
...
def calcSteadyState_simpleSystem(k_all, L = np.genfromtxt(dataPath + 'ligand.csv', delimiter = ',')):
...
if __name__ == '__main__':
    #kdraws = np.genfromtxt(dataPath + 'kdraws.csv', delimiter = ',')
